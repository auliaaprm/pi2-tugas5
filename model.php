...
class Model extends Connection
{
    ...
    {
        $sql = "DELETE FROM tbl_absen WHERE id='$absen_id'";
        $this->conn->query($sql);
    }
    ...
    {
        $sql = "DELETE FROM matakuliah WHERE id='$mk_id'";
        $this->conn->query($sql);
    }
    ...
    {
        $sql = "SELECT * FROM kontrak_mk WHERE matakuliah_id='id'";
        $bind = $this->conn->query($sql);
        while ($obj = $bind->fetch_object()) {
            $baris = $obj;
        }
    ...
    public function update_kontrak($matakuliah_id, $mhs_ids)
    {
        $sql = "UPDATE kontrak_mk SET mhs_id='$mhs_id' WHERE matakuliah_id='$matakuliah_id'";
        $this->conn->query($sql);
    }
    public function delete_kontrak($kontrak_id)
    {
        $sql = "DELETE FROM kontrak_mk WHERE matakuliah_id='$kontrak_id'";
        $this->conn->query($sql);
    }
}